        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="flex items-end gap-4 mb-8 pb-8 border-b border-white/5">
              <div className="text-4xl md:text-5xl font-bold text-white bg-clip-text">
            ...
            <div className="mb-10">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-300">File Google Sheets Premium (Siap Pakai)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <CheckCircle2 size={14} className="text-green-400" />
                  </div>
                  <span className="text-neutral-300">Otomasi Apps Script (Berjalan di background)</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <CheckCircle2 size={14} className="text-green-400" />
                  </div>
                  <span className="text-neutral-300">Video Panduan Step-by-Step Cara Setup & Penggunaan</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <CheckCircle2 size={14} className="text-green-400" />
                  </div>
                  <span className="text-neutral-300">Akses Grup Diskusi / Support 1-on-1 via WhatsApp</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-b from-white/5 to-transparent p-1 rounded-3xl">
              <button className="w-full bg-white text-black py-5 rounded-[20px] text-lg font-bold hover:bg-neutral-200 active:scale-[0.98] transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)] flex items-center justify-center gap-3 group">
                Beli & Dapatkan Akses
