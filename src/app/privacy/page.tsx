...
export const metadata: Metadata = {
  title: "Kebijakan Privasi | Pakarsheet",
  description: "Kebijakan privasi Pakarsheet. Informasi yang kami kumpulkan, cara penggunaannya, dan komitmen keamanan data kamu.",
};
