    ...
    <section id="fitur" className="py-20 md:py-32 relative">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
          ...
          <SpotlightCard className="md:col-span-2 rounded-[32px] border border-white/10 bg-[#0a0a0a] overflow-hidden group hover:border-white/20 transition-colors">
            <div>
              <div className="h-48 bg-gradient-to-br from-neutral-900 to-black relative p-6 border-b border-white/5 flex items-center justify-center overflow-hidden">
                ...
                <div className="w-full max-w-xs space-y-3 relative z-10 group-hover:scale-105 transition-transform duration-300">
          ...
          <SpotlightCard className="rounded-[32px] border border-white/10 bg-[#0a0a0a] overflow-hidden group hover:border-white/20 transition-colors">
            <div>
          ...
          <SpotlightCard className="md:col-span-2 rounded-[32px] border border-white/10 bg-[#0a0a0a] overflow-hidden group hover:border-white/20 transition-colors">
            <div>
              <div className="h-48 bg-gradient-to-tr from-neutral-900 to-black p-6 border-b border-white/5 flex items-center justify-center relative">
                <div className="flex items-center gap-4 bg-white/5 border border-white/10 px-6 py-4 rounded-xl relative z-10 opacity-40">
